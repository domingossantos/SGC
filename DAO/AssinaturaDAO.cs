...
namespace DAO
{
    public class AssinaturaDAO
    {
        ...
        public DataTable getAssinaturas(string nrCartao)
        {
            try
            {
                String sql = "select dtAssinatura from tblAssinaturas where nrCartao = '" + nrCartao.PadLeft(7,'0') + "' order by dtAssinatura desc";
        ...
        public DataTable getCartoes(string nrCartaoIni, string nrCartoesFim)
        {
            try
            {
                String sql = "select nrCartao from tblCartaoAssinatura where nrCartao between '" + nrCartaoIni + "' and '"+nrCartoesFim+"'";
                DataTable dados = new DataTable();
        ...
        public DataTable getAssinaturasPorTamanho(Int32 _tamanho) {
            ...
            sql.Append("from tblAssinaturas ");
