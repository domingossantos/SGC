namespace sgc.assinaturas
{
    partial class ImpressaoRGForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "dsImagemRG";
            reportDataSource1.Value = this.tblCartaoAssinaturaBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "sgc.relatorios.relImpressaoRG.rdlc";
            ...
            this.Name = "ImpressaoRGForm";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "ImpressaoRGForm";
            this.Load += new System.EventHandler(this.ImpressaoRGForm_Load);
